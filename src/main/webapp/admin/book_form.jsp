		...
		<table class="form">
			...
			<tr>
				...
				<td align="left">
					...
					<img id="thumbnail" alt="Image Preview" style="width:15%; margin-top: 10px" 
	...
	$(document).ready(function() {
		...
		$("#bookForm").validate({
			...
			messages: {
				...
				author: " Please enter a author of the book",
				isbn: " Please enter a ISBN of the book",
				publishDate: " Please enter a published date of the book",
